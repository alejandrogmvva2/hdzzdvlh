...
const defaultSong = {
  id: "1",
  user: "Tursky",
  videoURL: "https://www.youtube.com/watch?v=8vPxDAMqGeI",
  title: "Mariah Angeliq - Perreito (Official Video)",
  thumbnail: "http://i3.ytimg.com/vi/8vPxDAMqGeI/hqdefault.jpg",
  time: new Date(),
};
    ...
    <section className="VideoPlayer">
      ...
      <div className="SongContainer">
        <div className="Info">
          ...
          <p className="activesong-user">Solicitado por: {activeSong.user}</p>
        </div>
